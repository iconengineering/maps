...
// Initialize Firebase
  var config = {
    apiKey: "AIzaSyAwGCoxTHVbOuJjy1HiCPViG_99m4LUIY8",
    authDomain: "boulder-stormwater.firebaseapp.com",
    databaseURL: "https://boulder-stormwater.firebaseio.com",
    projectId: "boulder-stormwater",
    storageBucket: "boulder-stormwater.appspot.com",
    messagingSenderId: "835090415156"
  };
...
var dataRef = firebase.database().ref('SBKTwomileGooseComments');
    ...
    dataRef.orderByChild('id').equalTo(editFeature.id).once('value', function(snapshot) {
      ...
      // push response and notes to firebase
        ...
        // set semantic data for point
            ...
            firebase.database().ref('SBKTwomileGooseComments/' + featureKey).update(draw.getSelected().features[0]);
        ...
        // delete feature
          deleteButton.addEventListener('click', function(){
            ...
            firebase.database().ref('SBKTwomileGooseComments/' + featureKey).remove();
...
var firePopupTouch = function (e) {
  ...
  response.innerHTML = '<div class="divider"></div><span class="popup-title">City\'s Response:</span> ' + feature.properties.response + '<br />';
